...
# File Name: joplin.sh
# Author: paigu
# Created Time: 一  6/ 5 20:23:51 2023
#########################################################################
#!/bin/zsh
...
check_installed_status(){
	[[ ! -e ${aria2c} ]] && echo -e "${Error} Joplin 没有安装，请检查 !" && exit 1
	[[ ! -e ${aria2_conf} ]] && echo -e "${Error} Joplin 配置文件不存在，请检查 !" && [[ $1 != "un" ]] && exit 1
}
...
————————————
 ${Green_font_prefix} 1.${Font_color_suffix} 安装 Joplin
 ${Green_font_prefix} 2.${Font_color_suffix} 更新 Joplin
 ${Green_font_prefix} 3.${Font_color_suffix} 卸载 Joplin
————————————
 ${Green_font_prefix} 4.${Font_color_suffix} 启动 Joplin
 ${Green_font_prefix} 5.${Font_color_suffix} 停止 Joplin
 ${Green_font_prefix} 6.${Font_color_suffix} 重启 Joplin
————————————
